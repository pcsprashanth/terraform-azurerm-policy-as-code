...
locals {
  ...
  definition_id = var.subscription_id != null ? "${var.subscription_id}/providers/Microsoft.Authorization/policyDefinitions/${local.policy_name}" : azurerm_policy_definition.def.id
}
